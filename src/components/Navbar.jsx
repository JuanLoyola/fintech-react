		...
		<div className='shadow text-black h-14 flex justify-center items-center'>
			<div className='w-full lg:max-w-3xl flex justify-between items-center px-12 text-sm'>
				...
				<ul className='hidden w-[18rem] md:flex justify-between items-center'>
					<li className='font-medium text-sm hover:text-gray-200 cursor-pointer transition-all'>Home</li>
					<li className='font-medium text-sm hover:text-gray-200 cursor-pointer transition-all'>About</li>
					<li className='font-medium text-sm hover:text-gray-200 cursor-pointer transition-all'>Services</li>
					<li className='font-medium text-sm hover:text-gray-200 cursor-pointer transition-all'>Crypto</li>
				</ul>
				<ul className='hidden w-[12rem] md:flex justify-between items-center'>
					<li className='font-medium text-sm hover:text-gray-200 cursor-pointer transition-all'>Log In</li>
					<li className='font-medium text-sm bg-indigo-500 hover:bg-indigo-600 hover:text-gray-200 px-7 py-2 rounded-md cursor-pointer transition-all'>Sign Up</li>
				</ul>
				...
				{/* options panel */}
				<div className={isNavOpen ? 'md:hidden absolute top-12 right-0 h-screen w-full' : 'hidden'}>
